...
public class SampleOrders {
	...
	public String toString() {
		return "SampleOrders [id=" + id + ", institute_id=" + institute_id + ", company_id=" + company_id
				+ ", buyer_id=" + buyer_id + ", order_no=" + order_no + ", factory_id=" + factory_id + ", po_no="
				+ po_no + ", issue_date=" + issue_date + ", order_date=" + order_date + ", delivery_date="
				+ delivery_date + ", reference=" + reference + ", terms=" + terms + ", merchandiser=" + merchandiser
				+ ", receive_person_id=" + receive_person_id + ", quantity=" + quantity + ", total_amount="
				+ total_amount + ", sample_design=" + sample_design + ", order_status=" + order_status
				+ ", stock_status=" + stock_status + ", delivery_status=" + delivery_status + ", production_status="
				+ production_status + ", created_by=" + created_by + ", created_date=" + created_date + ", modified_by="
				+ modified_by + ", modified_date=" + modified_date + ", is_deleted=" + is_deleted + ", _key=" + _key
				+ "]";
	}
