...
import com.test.my_packages.repositories.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
	...
	/*
	 * public Products updateProducts(Products products) { Products dbProducts =
	 * productsRepository.getOne(product.getId());
	 * 
	 * dbProducts.setProductsName(products.getProductName());
	 * dbProducts.setProductsCategory(products.getProductCategory()); return
	 * productsRepository.save(dbProducts); }
	 */
